...
########################3
        try:
            ...
            if (len(list(opt_problem._constraints.keys())) > 0):
            ...
            if (len(list(opt_problem.constraints.keys())) > 0):
                for key in list(opt_problem.constraints.keys()):
    ...
    def setOption(self, name, value=None):
        ...
        **Keyword arguments:**
        ...
        if name in def_options:
            ...
            raise IOError(repr(name) + ' is not a valid option name'+', valid names are: '+str(def_options))
        #end
